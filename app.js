        ...
        getInput: function() {
         ...
         html = '<div class="item clearfix" id="inc-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>'
          ...
          displayBudgetOnUI : function(obj){
           document.querySelector(DOMStrings.budgetLable).textContent = obj.totalBudget;
      ...
      //A function that will store the new entered item in relevant data structure based on its type(we pass des and val parameters to create a new object of constructor 'Expense' or 'Income' based on the 'Type' parameter) 
        ...
        */
        ...
        calculateBudget : function(){
         ...
         storeData.totalItems.budget = storeData.totalItems.inc - storeData.totalItems.exp;
         //calculate percentage
         if(storeData.totalItems.inc>0){
          storeData.totalItems.percentage = Math.round((storeData.totalItems.exp/storeData.totalItems.inc) * 100)
         } else{
       ...
       //setup event listener for the value input box
        ...
        var getItem = function(){
         ...
         if(input.description != '' && input.value != isNaN(input.value) && input.value>0){
            ...
            var addNewItem = budCntrl.cntrlNewItem(input.type, input.description,input.value);
